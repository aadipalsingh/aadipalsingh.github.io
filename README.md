...
- **Experience Timeline:** Details of my internships and education.
- **Contact Form:** Integrated way to reach out via email.

## 🛠️ Built With
- **HTML5 & CSS3:** For structure and styling.
- **JavaScript:** For interactive elements (Dark mode, animations).
